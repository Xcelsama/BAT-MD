...
try {
    ...
    console.log("🌍 𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐓𝐨 𝐓𝐡𝐞 𝐁𝐀𝐓 𝐃𝐀𝐓𝐀𝐁𝐀𝐒𝐄")
} catch {
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://batbot.tech/wiki')
	}
    }
    main()
    //========================================================================================================================================
 ...
 Void.ev.on('group-participants.update', async(anu) => {
                    ...
                    if (checkinfo) {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            let buttons = [
                                { buttonId: `huh`, buttonText: { displayText: 'Enjoy 𝙱𝚊𝚝-𝚋𝚘𝚝' }, type: 1 }
                            ]
                            let buttonMessage = {
                                image: {url : ppUrl },
                            ...
                            let buttonMessage = {
                                image: { url : ppUrl },
                                caption: `[ BAT-BOT:-DEMOTE - DETECTED ]\n\nName : @${num.split("@")[0]}\nStatus : Admin -> Member`,
                                footer: `Secktor`,
                                mentions: [num],
                                buttons: buttons,
                                headerType: 4,
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("ℹ️ Bat-bot 🦇Connecting to WhatsApp... Please Wait.");
                }
                if (connection === 'open') {
                    console.log("✅ Login Successful!");
                    console.log("⬇️  Installing External Plugins in Bat-bot...");
                    ...
                    console.log("✅  External Plugins Installed in Bat-bot!");
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `_𝐁𝐀𝐓-𝐁𝐎𝐓 𝐢𝐬 𝐎𝐧𝐥𝐢𝐧𝐞...._\n\n_𝐏𝐫𝐞𝐟𝐢𝐱 : [ ${prefix} ]_\n_𝐓𝐨𝐭𝐚𝐥 𝐏𝐥𝐮𝐠𝐢𝐧𝐬* : ${events.commands.length}_\n_𝐌𝐨𝐝𝐞: ${Config.WORKTYPE}_\n_*𝐕𝐞𝐫𝐬𝐢𝐨𝐧*:- 𝐋𝐀𝐓𝐄𝐒𝐓_\n_𝐁𝐫𝐚𝐧𝐜𝐡:- ${Config.BRANCH}_\n_𝐓𝐡𝐞𝐦𝐞:𝐁𝐀𝐓.𝐣𝐬𝐨𝐧_\n_𝐎𝐰𝐧𝐞𝐫:- ${process.env.OWNER_NAME}_\n\n 𝐁𝐀𝐓𝐌𝐀𝐍 \n https://whatsapp.com/channel/0029Va9wmuz8F2pGIURwmo0m` })
                    }
                }
               if (connection === "close" && lastDisconnect && lastDisconnect.error && lastDisconnect.error.output.statusCode != 401 ) {
                    console.log('Connection closed with bat-bot. Please put New Session ID again.');
                    await sleep(50000);
